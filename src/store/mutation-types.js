...
export const RECEIVE_CATEGORYS='receive_categorys'//接受分类
export const RECEIVE_SHOPS='receive_shops'//接受上架
export const RECEIVE_USER_INFO='receive_user_info'//存储用户信息
export const RESET_USER_INFO='reset_user_info'//存储用户信息
